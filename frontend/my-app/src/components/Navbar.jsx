          ...
          <div className="hidden md:flex items-center space-x-8">
            ...
            {user?.role === "Job Seeker" && (
              <>
                <Link
                  to="/profile"
                  className={`px-3 py-2 text-sm font-medium ${location.pathname === "/profile" ? "text-indigo-600 border-b-2 border-indigo-600" : "text-gray-700 hover:text-indigo-500"} transition-colors duration-200`}
                >
                  Profile
                </Link>
                <Link
                  to="/my-applications"
                  className={`px-3 py-2 text-sm font-medium ${location.pathname === "/my-applications" ? "text-indigo-600 border-b-2 border-indigo-600" : "text-gray-700 hover:text-indigo-500"} transition-colors duration-200`}
                >
                  My Applications
                </Link>
              </>
          ...
          <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
            ...
            {user?.role === "Job Seeker" && (
              <>
                <Link
                  to="/profile"
                  className={`block px-3 py-2 rounded-md text-base font-medium ${location.pathname === "/profile" ? "bg-indigo-50 text-indigo-600" : "text-gray-700 hover:bg-gray-50 hover:text-indigo-600"} transition-colors duration-200`}
                >
                  Profile
                </Link>
                <Link
                  to="/my-applications"
                  className={`block px-3 py-2 rounded-md text-base font-medium ${location.pathname === "/my-applications" ? "bg-indigo-50 text-indigo-600" : "text-gray-700 hover:bg-gray-50 hover:text-indigo-600"} transition-colors duration-200`}
                >
                  My Applications
                </Link>
              </>
